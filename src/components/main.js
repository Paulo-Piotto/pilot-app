    ...
    <Background>
      ...
      <SideMenu>
        <IconsContainer>
          ...
          <IconBox
            isSelected={selectedIcon === "time" ? true : false}
            onClick={() => {
              selectPage("time", "/frequency");
            }}
          >
            <IoTimeOutline />
          </IconBox>
          <IconBox
            isSelected={selectedIcon === "employees" ? true : false}
            onClick={() => {
              selectPage("employees", "/employees");
            }}
          >
            <IoPeopleOutline />
          </IconBox>
          ...
          <IconBox
            ...
            onClick={() => {
              selectPage("clients", "/clients");
            }}
          >
            <IoBriefcaseOutline />
          </IconBox>
          <IconBox
            isSelected={selectedIcon === "stores" ? true : false}
            onClick={() => {
              selectPage("stores", "/stores");
            }}
          >
            <IoStorefrontOutline />
          </IconBox>
          <IconBox
            isSelected={selectedIcon === "incomes" ? true : false}
            onClick={() => {
              selectPage("incomes", "/incomes");
            }}
          >
            <IoCashOutline />
          </IconBox>
