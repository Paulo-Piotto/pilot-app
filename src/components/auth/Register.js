...
export default function Register({ side: animationSide, callLoginScreen }) {
  ...
  function handleRegistration() {
    ...
    configuredRegisterValidate.passwordConfirmation =
      configuredRegisterValidate.passwordConfirmation(newUser.password);
    ...
    >
      ...
      <form autoComplete="off" onSubmit={(e) => e.preventDefault()}>
        ...
        <sc.CssTextField
          ...
          onChange={(e) =>
            updateNewUserData({ passwordConfirmation: e.target.value })
          }
          focuscolor="#bb9d6f"
        />
        ...
        >
          {isLoading ? (
            ...
            <FileUploadIcon sx={{ fontSize: 50, color: "#bb9d6f" }} />
          )}
        </sc.SendButton>
      </form>
    </sc.AuthContainer>
