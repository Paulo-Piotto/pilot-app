...
export default function OrderDetailsDialog({rowData, openDialog, handleCloseDialog}){   
    return(
        <>
        ...
        <DialogContent> 
            ...
            />
            <TextField
                value={rowData.value_negotiated ? `R$ ${intToMoney(rowData.value_negotiated)}` : 'n/a'}
                margin="dense"
                id="value"
